#!/usr/bin/env python3
"""
Multi-seed training script for PD-iPINN paper reproducibility.

Usage:
    python train.py                     # Run all seeds
    python train.py --seeds 42 43       # Run specific seeds
    python train.py --dry-run           # Show configuration only
"""
...
GRID_CONFIGS = [
    # num_x sweep (num_t=101 fixed)
    (11, 101), (21, 101), (31, 101), (41, 101), (51, 101),
    (61, 101), (71, 101), (81, 101), (91, 101), (101, 101),
    # num_t sweep (num_x=51 fixed)
    (51, 11), (51, 21), (51, 31), (51, 41), (51, 51),
    (51, 61), (51, 71), (51, 81), (51, 91),
]
...
D_COEFF = 0.01
K_COEFF = 0.5
DECAY_RATE = D_COEFF * (np.pi ** 2) + K_COEFF
...
def main():
    parser = argparse.ArgumentParser(description='Multi-seed training for PD-iPINN')
    ...
    print("=" * 60)
    print("PD-iPINN Multi-Seed Training")
    print("=" * 60)
    print(f"Seeds: {seeds}")
